...
En premier lieu, nous trouvions intéressant de connaître la date exacte où il y a eu le plus de criminalité.
```{r}
...
En dernier lieu, nous voulions effectuer un test d'hypothèse afin de savoir si l'âge moyen des victimes de Los Angeles est de 33 ans (Nous utiliserons un niveau de signification de 0,05)
```{r}
test<- crime_la |>
